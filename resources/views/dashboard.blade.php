    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end" style="background-color: #F9A835" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a class="list-group-item p-3 custom-bg-color fw-semibold" href="{{ url('/') }}"><i class="fas fa-house"></i><span style="margin-left: 10px">Home</span></a>
                <a class="list-group-item p-3 custom-bg-color fw-semibold" href="{{ url('/profile') }}"><i class="fas fa-user"></i><span style="margin-left: 14px">Profil</span></a>
                <a class="list-group-item p-3 custom-bg-color fw-semibold" href="{{ url('/jadwal') }}"><i class="fas fa-calendar-days"></i>
                    <span style="margin-left: 10px">Jadwal</span></a>
                <a class="list-group-item p-3 custom-bg-color fw-semibold" href="{{ url('/pembayaran') }}"><i class="fas fa-wallet"></i><span style="margin-left: 12px">Pembayaran
                        SPP</span></a>
                <a class="list-group-item p-3 custom-bg-color fw-semibold" href="{{ url('/login') }}"><i class="fas fa-right-from-bracket"></i>
