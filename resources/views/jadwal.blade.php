        ...
        <div class="card" style=" height: 55rem; margin-top: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);">
            <div class="card-body">
                ...
                <div class="table-all-container">
                    ...
                    <div class="table-container">
                        <table class="table-bordered" style="height: 200px; margin-top: 20px;">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 70px;">
                                        <select class="form-select"
                                            style="width: 150px;margin: 0 auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2); border-color: #042F66;">
                        ...
                        <button type="button" class="btn"
                            style="margin-top: 10px; background-color:  #042F66; color: white;">
