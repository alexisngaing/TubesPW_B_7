...
<div class="container-fluid" style="background-color: #F5F5F5; padding-top: 1px;">
    <div class="card" style="width: 50 rem; height:55rem; margin-top: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);">
        <div class="card-body">
            ...
            <div style="display: flex">
                ...
                <div style="width: 30%;">
                    <table class="table-bordered" style="width: 80%; height: 200px; margin-top: 20px; margin-left: 40px;">
                        <tbody>
                            <tr>
                                <td class="text-center" style="width: 50px; background-color: #042F66; color: white; font-weight: bold;">
                                    Jurusan</td>
                                <td class="text-center" style="width: 70px;">
                                    <select class="form-select" style="width: 150px;margin: 0 auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.2); border-color: #042F66;">
